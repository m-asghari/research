...
INSERT INTO PATH2_EDGES VALUES (770103, 770475, 1.57762844801944, 65.0);
...
INSERT INTO PATH2_EDGES VALUES (769847, 767610, 1.70682627230272, 65.0);
...
INSERT INTO PATH2_EDGES VALUES (767495, 716955, .638013653725755, 65.0);
INSERT INTO PATH2_EDGES VALUES (716955, 716949, 1.16100845396918, 65.0);
...
INSERT INTO PATH2_EDGES VALUES (718045, 760643, 1.96771011537408, 65.0);
...
CREATE TABLE PATH2_SPEED_PATTERNS (
  LINK_ID NUMBER,
...
INSERT INTO PATH2_SPEED_PATTERNS VALUE
SELECT *
...
INSERT INTO PATH2_EDGE_PATTERNS
SELECT "FROM", "TO", FROM_TIME, '', '', (DISTANCE*2*3600)/(FROM_SPEED + TO_SPEED), (DISTANCE*100*3600)/(60*MAX_SPEED)
FROM TEMP;
UPDATE PATH2_EDGE_PATTERNS SET DAY = TO_CHAR(TIME, 'DDD'), TOD = TO_CHAR(TIME,'hh24:mi:ss'); 
COMMIT;
